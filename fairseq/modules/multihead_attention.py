...
class MultiheadAttentionDropoutHead(MultiheadAttention):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, head_dropout_num=1):
        super().__init__(
            embed_dim,
            num_heads,
            dropout=dropout,
        ...
        self.head_dropout_num = head_dropout_num
    ...
    def forward(self, query, key, value, key_padding_mask=None, incremental_state=None,
        ...
        batch x src_len, where padding elements are indicated by 1s.
        """
        attn, attn_weights = super(MultiheadAttentionDropoutHead, self).forward(query,
                                                                                key,
                                                                                value,
...
class MultiheadAttentionExtraLoss(MultiheadAttention):
    ...
    def forward(self, query, key, value, key_padding_mask=None, incremental_state=None,
        ...
        # num_head, bsz, tgt_len, src_len
        # implementing AI LAB's paper
        attn_weights = attn_weights.view(bsz, self.num_heads, tgt_len, src_len)
